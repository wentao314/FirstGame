...
public abstract class Move {
     ...
     * @param board current board
     * @param destinationCoordinate destination of the piece after the move
     */
    private Move(final Board board,
                 final int destinationCoordinate) {
        this.board = board;
    ...
    /**
     * Calculates the hash code for the move based on their attributes.
    ...
    /**
     * Checking object equality based on same destination coordinate and moved piece.
     * @param other the reference object with which to compare
     * @return {@code true} if the object is identical to the {@link Move}, otherwise {@code false}
     */
    @Override
    ...
    static abstract class CastleMove extends Move {
        ...
        /**
         * Executes castling by moving king and rook and leaving everything else as is.
         * @return the new board after executing
         */
        @Override
        public Board execute() {
            final Builder builder = new Builder();
            ...
            builder.setPiece(this.movedPiece.movePiece(this));
            // TODO first move on normal pieces
